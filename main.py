from consultas import buscar_livros, detalhes_livro, listar_autores_com_quantidade, listar_livros, livros_por_autor
...
with nova_sessao() as session:
    ...
    print("\nLivros de um autor")
    livros_por_autor(session, "George Orwell")
    
    print("\nBusca por parte do título")
    buscar_livros(session, "Sonho")
